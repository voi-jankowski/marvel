...
function getApi() {
  ...
  var requestUrl = "https://imdb-api.com/en/API/SearchMovie/" + apiKey + "/" + expression;
  ...
  fetch(requestUrl)
    ...
    .then(function (data) {
      ...
      var requestUrl2 = "https://imdb-api.com/en/API/Title/" + apiKey + "/" + data.results[0].id + "/Trailer";
