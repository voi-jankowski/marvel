...
function getApi() {
    var requestUrl = 'http://gateway.marvel.com/v1/public/characters?name=Hulk&' + parameter;
    ...
    fetch(requestUrl)
        ...
        .then(function (data) {
            ...
            console.log(data);
            heroImage.attr("src", data.data.results[0].thumbnail.path + '.' + data.data.results[0].thumbnail.extension);
            ...
            for (var i = 0; i < comicsItem.length; i++) {
                ...
                fetch(requestUrl2)
                    ...
                    .then(function (data) {
                        ...
                        var comicImage = $("<img>");
                        comicImage.attr("src", data.data.results[0].thumbnail.path + '.' + data.data.results[0].thumbnail.extension);
